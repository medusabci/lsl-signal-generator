...
class NotificationStack:
    ...
    def __init__(self, parent, anim_ms=1000, timer_ms=2000):
        self.parent = parent
...
class NotificationBubble(QLabel):
    ...
    def __init__(self, parent=None, message='Notification message', offset_height=0, anim_ms=1000, timer_ms=2000):
        ...
        self.setMinimumSize(400, 35)        # Required to view the border rounded
